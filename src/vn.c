...
static const unsigned short viscii_vni_data[] =
  {
    ...
    146, u('O'), u('\xC3'), DONE,
    147, u('O'), u('\xC4'), DONE,
    148, u('\xD4'), u('\xCF'), DONE,
    149, u('\xD4'), u('\xD9'), DONE,
    150, u('\xD4'), u('\xD8'), DONE,
    151, u('\xD4'), u('\xDB'), DONE,
    152, u('\xD2'), DONE,
    153, u('O'), u('\xDB'), DONE,
    154, u('O'), u('\xCF'), DONE,
    155, u('\xC6'), DONE,
    ...
    177, u('o'), u('\xE5'), DONE,
    178, u('o'), u('\xE3'), DONE,
    179, u('\xD4'), u('\xD5'), DONE,
    180, u('\xD4'), DONE,
    181, u('o'), u('\xE4'), DONE,
    182, u('\xF4'), u('\xF8'), DONE,
    183, u('\xF4'), u('\xFB'), DONE,
    184, u('\xF2'), DONE,
    185, u('\xD6'), u('\xCF'), DONE,
    186, u('\xD6'), u('\xD9'), DONE,
    187, u('\xD6'), u('\xD8'), DONE,
    188, u('\xD6'), u('\xDB'), DONE,
    189, u('\xF4'), DONE,
    190, u('\xF4'), u('\xF9'), DONE,
    191, u('\xD6'), DONE,
    192, u('A'), u('\xD8'), DONE,
    193, u('A'), u('\xD9'), DONE,
    194, u('A'), u('\xC2'), DONE,
    ...
    207, u('y'), u('\xF8'), DONE,
    208, u('\xD1'), DONE,
    209, u('\xF6'), u('\xF9'), DONE,
    210, u('O'), u('\xD8'), DONE,
    211, u('O'), u('\xD9'), DONE,
    212, u('O'), u('\xC2'), DONE,
    213, u('a'), u('\xEF'), DONE,
    214, u('y'), u('\xFB'), DONE,
    215, u('\xF6'), u('\xF8'), DONE,
    216, u('\xF6'), u('\xFB'), DONE,
    217, u('U'), u('\xD8'), DONE,
    218, u('U'), u('\xD9'), DONE,
    219, u('y'), u('\xF5'), DONE,
    220, u('\xEE'), DONE,
    221, u('Y'), u('\xD9'), DONE,
    222, u('\xF4'), u('\xF5'), DONE,
    223, u('\xF6'), DONE,
    224, u('a'), u('\xF8'), DONE,
    225, u('a'), u('\xF9'), DONE,
    226, u('a'), u('\xE2'), DONE,
    ...
    252, u('u'), u('\xFB'), DONE,
    253, u('y'), u('\xF9'), DONE,
    254, u('\xF4'), u('\xEF'), DONE,
    255, u('\xD6'), u('\xD5'), DONE,
    DONE
  };
